// d3d_models.cpp -- model loading and caching
...
//			texture_mode = GL_LINEAR_MIPMAP_NEAREST; //_LINEAR;
			tx->gl_texturenum = D3D_LoadTexture (mt->name, tx->width, tx->height, (byte *)(tx+1), true, false);
...
#ifndef QUAKE2
			D3D_SubdivideSurface (out);	// cut up polygon for warps
#endif
			continue;
		}
...
void *Mod_LoadAllSkins (int numskins, daliasskintype_t *pskintype)
{
	...
	//		}
			...
			pheader->gl_texturenum[i][3] =
				D3D_LoadTexture (name, pheader->skinwidth, 
...
=================
*/
void D3D_MakeAliasModelDisplayLists (model_t *m, aliashdr_t *hdr);
void Mod_LoadAliasModel (model_t *mod, void *buffer)
{
	int					i, j;
	mdl_t				*pinmodel;
...
// FIXME: do this right
	...
	//
	D3D_MakeAliasModelDisplayLists (mod, pheader);
...
void * Mod_LoadSpriteFrame (void * pin, mspriteframe_t **ppframe, int framenum)
{
	...
	*ppframe = pspriteframe;
	...
	pspriteframe->gl_texturenum = D3D_LoadTexture (name, width, height, (byte *)(pinframe + 1), true, true);
