...
qboolean VID_SetWindowedMode (int modenum)
{
	...
	//ExWindowStyle = 0;
	//ExWindowStyle = WS_EX_TOOLWINDOW; //syq 2000.10.31
...
// empty while Quake starts up.
	...
	//if (vid.conheight > modelist[modenum].height) //888
		vid.conheight = modelist[modenum].height;
	//if (vid.conwidth > modelist[modenum].width) //888
